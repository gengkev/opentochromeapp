 ...
 * 
 * Modifications:
 *   - Compiled using Closure Compiler (Basic) on 4-6-2011 http://closure-compiler.appspot.com/home
 * Note: I didn't use the provided min version, I used the original
 */
var hexcase = 0;  // hex output format. 0 - lowercase; 1 - uppercase
var b64pad  = ""; // base-64 pad character. "=" for strict RFC compliance
function hex_sha1(b){return rstr2hex(rstr_sha1(str2rstr_utf8(b)))}function b64_sha1(b){return rstr2b64(rstr_sha1(str2rstr_utf8(b)))}function any_sha1(b,c){return rstr2any(rstr_sha1(str2rstr_utf8(b)),c)}function hex_hmac_sha1(b,c){return rstr2hex(rstr_hmac_sha1(str2rstr_utf8(b),str2rstr_utf8(c)))}function b64_hmac_sha1(b,c){return rstr2b64(rstr_hmac_sha1(str2rstr_utf8(b),str2rstr_utf8(c)))}
...
function rstr2any(b,c){var a=c.length,d=[],e,f,g,h,j=Array(Math.ceil(b.length/2));for(e=0;e<j.length;e++)j[e]=b.charCodeAt(e*2)<<8|b.charCodeAt(e*2+1);for(;j.length>0;){h=[];for(e=g=0;e<j.length;e++)if(g=(g<<16)+j[e],f=Math.floor(g/a),g-=f*a,h.length>0||f>0)h[h.length]=f;d[d.length]=g;j=h}a="";for(e=d.length-1;e>=0;e--)a+=c.charAt(d[e]);d=Math.ceil(b.length*8/(Math.log(c.length)/Math.log(2)));for(e=a.length;e<d;e++)a=c[0]+a;return a}
function str2rstr_utf8(b){for(var c="",a=-1,d,e;++a<b.length;)d=b.charCodeAt(a),e=a+1<b.length?b.charCodeAt(a+1):0,55296<=d&&d<=56319&&56320<=e&&e<=57343&&(d=65536+((d&1023)<<10)+(e&1023),a++),d<=127?c+=String.fromCharCode(d):d<=2047?c+=String.fromCharCode(192|d>>>6&31,128|d&63):d<=65535?c+=String.fromCharCode(224|d>>>12&15,128|d>>>6&63,128|d&63):d<=2097151&&(c+=String.fromCharCode(240|d>>>18&7,128|d>>>12&63,128|d>>>6&63,128|d&63));return c}
